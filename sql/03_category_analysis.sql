-- -- Phase 2.1: Analyze Current Category Distribution
-- -- This query identifies the current distribution of categories based on the existing CASE WHEN logic
-- -- Use results to understand merge candidates
